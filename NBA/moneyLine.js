...
async function run() {
    ...
    fs.readFile('./inputml.txt', 'utf8' , (err, data) => {
        if (err) 
        {
            console.error(err);
            return;
        ...
        con.connect(function(err) {
            ...
            for(var i = 0; i < data.length; i++)
            {
                if(data[i] == "\n")
                {
                    ...
                    if((team1.score/team1.games - team2.score/team2.games) >= 5)
                    {
                        output += "Regular: "+team1.mascot+" "+team1ML+" by "+(team1.score/team1.games - team2.score/team2.games)+"\n";
                        sql = `INSERT INTO NBAPICKSML(date, picktype, team, odds, winby, inj5) VALUES('${today}', 'Regular', '${team1.abreviation}', ${Number(team1ML)}, ${Math.abs(team1.score/team1.games - team2.score/team2.games)}, 0);`;
                        con.query(sql, function (err, result) {
                            if (err) throw err;
                            console.log("Number of records inserted: " + result.affectedRows);
                        });
                    }
                    else if((team1.score/team1.games - team2.score/team2.games) <= -5)
                    {
                        output += "Regular: "+team2.mascot+" "+team2ML+" by "+(team1.score/team1.games - team2.score/team2.games)+"\n";
                        sql = `INSERT INTO NBAPICKSML(date, picktype, team, odds, winby, inj5) VALUES('${today}', 'Regular', '${team2.abreviation}', ${Number(team2ML)}, ${Math.abs(team1.score/team1.games - team2.score/team2.games)}, 0);`;
                        con.query(sql, function (err, result) {
                            if (err) throw err;
                            console.log("Number of records inserted: " + result.affectedRows);
                        });
                    }
                    if((team1.weightedScore/team1.games + team1.score/team1.games - team2.weightedScore/team2.games - team2.score/team2.games) >= 5)
                    {
                        output += "Weighted: "+team1.mascot+" "+team1ML+" by "+(team1.weightedScore/team1.games + team1.score/team1.games - team2.weightedScore/team2.games - team2.score/team2.games)+"\n";
                        sql = `INSERT INTO NBAPICKSML(date, picktype, team, odds, winby, inj5) VALUES('${today}', 'Weighted', '${team1.abreviation}', ${Number(team1ML)}, ${Math.abs(team1.weightedScore/team1.games + team1.score/team1.games - team2.weightedScore/team2.games - team2.score/team2.games)}, 0);`;
                        con.query(sql, function (err, result) {
                            if (err) throw err;
                            console.log("Number of records inserted: " + result.affectedRows);
                        });
                    }
                    else if((team1.weightedScore/team1.games + team1.score/team1.games - team2.weightedScore/team2.games - team2.score/team2.games) <= -5)
                    {
                        output += "Weighted: "+team2.mascot+" "+team2ML+" by "+(team1.weightedScore/team1.games + team1.score/team1.games - team2.weightedScore/team2.games - team2.score/team2.games)+"\n";
                        sql = `INSERT INTO NBAPICKSML(date, picktype, team, odds, winby, inj5) VALUES('${today}', 'Weighted', '${team2.abreviation}', ${Number(team2ML)}, ${Math.abs(team1.weightedScore/team1.games + team1.score/team1.games - team2.weightedScore/team2.games - team2.score/team2.games)}, 0);`;
                        con.query(sql, function (err, result) {
                            if (err) throw err;
                            console.log("Number of records inserted: " + result.affectedRows);
                        });
            ...
            fs.writeFile('./outputml.txt', output, err => {
                if (err) {
                    console.error(err);
                    return;
                }
