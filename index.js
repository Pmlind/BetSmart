...
function NFL_picks_fetch(){
  ...
  console.log(NFL_picks.children.length);
  if(NFL_picks.children.length==0){
    ...
    $.ajax({
      ...
      $(document).ajaxStop(function() {
        ...
        var headers = ['week','picktype','team','spread','spreadby','inj','hit'];
...
function NFL_page(){
  toggle(document.getElementById('NFL'))
}

window.onload = function (){
  test("Kansas City Chiefs", "Philadelphia Eagles");
}